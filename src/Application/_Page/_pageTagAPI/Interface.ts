/// <amd-module name="Application/_Page/_pageTagAPI/IPageTagAPI" />
...
export interface IPageTagElement {
    ...
    toPageTag(): IPageTag;
    clear(): void;
    isEqual(name: string, attrs: IPageTagAttrs, content?: string, eventHandlers?: IPageTagEventHandlers): boolean;
...
export interface IPageTagAPIInternal {
     ...
     */
    createTag(name: string, attrs: IPageTagAttrs, content?: string, eventHandlers?: IPageTagEventHandlers): IPageTagId;
    /**
