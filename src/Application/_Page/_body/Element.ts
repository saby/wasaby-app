///// <amd-module name="Application/_Page/_body/Element" />
...
export default class Element extends ElementPS {
   ...
   toggleClass(token: string, force?: boolean): boolean {
      return document.body.classList.toggle(token, force);
   }
   ...
   private _notifyEventCrunch(): void {
      if (typeof window !== 'undefined') {
         ...
         window.document.body.dispatchEvent(
            new CustomEvent('_bodyClassesUpdateCrunch', {detail: this.getClasses()})
         );
      }
   }
}
