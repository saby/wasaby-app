...
export default class EnvNodeJS implements IEnv {
    ...
    constructor(data: Record<string, unknown>, console?: IConsole) {
        ...
        // logLevel для EnvNodeJS нигде не выставляется - видимо и не должен,
        // т.к. logLevel на PS предназначен для выставления уровня логирования в браузере
        const logLevel = this.envConfig.get('logLevel');
